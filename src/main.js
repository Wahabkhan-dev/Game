...
import { L5_IntroVideoScene }   from './scenes/levels/Level5/cinematics/L5_IntroVideoScene.js';
...
const config = {
  ...
  // Cloudinary videos are cross-origin — without this, the <video> element
  // gets CORS-tainted and WebGL silently refuses to draw its frames as a
  // texture (audio still plays fine since that doesn't go through canvas).
  loader: {
