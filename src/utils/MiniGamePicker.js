...
async function loadGameMap() {
  ...
  try {
    ...
    return {
      ...
      Level4: ['14-emotion-matching', '15-rhyme-time', '16-plant-growth-sequence', '17-traffic-light-rules', '09-pattern-sequence', '03-shape-sorter', '22-fruit-vegetable-sort', '26-space-objects-match'],
