...
export class L6_EquipmentRunScene extends Phaser.Scene {
  constructor() { super('L6_EquipmentRun'); }
  ...
  _buildPlayer() {
    ...
    // Animations are now set up by L6_GlendaSkin (after this method is called in create)
  ...
  _buildHUD() {
    ...
    this._cpTxt = this.add.text(W / 2, 16, 'CHECKPOINT 1 — Collect Stethoscope & Water Bowl', { fontSize: '12px', fontFamily: 'Georgia, serif', color: '#cfe0f5' }).setOrigin(0.5).setScrollFactor(0).setDepth(50);
    this._itemHud = {};
    ITEMS.forEach((it, i) => {
  ...
  _stopCheckpointOverlays() {
    ['L6_CP1', 'L6_CP2', 'L6_CP3'].forEach(k => {
