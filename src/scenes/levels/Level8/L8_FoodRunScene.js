...
export class L8_FoodRunScene extends L8BaseScene {
  ...
  create() {
    ...
    // ── HUD (Level 6 layout) ─────────────────────────────────────────────────
    // Unified Level-2 header (health · banner · timer · coin · menu) — runner stage
    this.buildTopBanner(1, 'Puppy Care Day', null, { timer: 90 });
    this._buildFoodPanel();   // collection module (below banner)
